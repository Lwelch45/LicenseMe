...
public class Tokenizer {
    ...
    public Tokenizer(List<String> text, Map<String, String> key_pairs, String delimeters) {
        this.text = text;
        this.key_pairs = key_pairs;
        Tokenizer.delimeters = delimeters;
    }
    ...
    public List<Token> tokenize() {
        ...
        for (int i = 0; i < text.size(); i++) {
            ...
            List<String> preprocessedTokens = split(replace(tmpLine), delimeters);
